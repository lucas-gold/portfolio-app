  ...
  downTimer = setInterval(function () {
    ...
    if (timeLeft == addedYtime + addedXtime - Math.floor(addedXtime / 3)) {
      if (successAttack == false && atkBool === true) {
        grid[fullyGrownArray[pos].x][fullyGrownArray[pos].y] = new cell(
          fullyGrownArray[pos].x,
          fullyGrownArray[pos].y,
          w
        ); //reset crop
...
function attacker() {
  if (fullyGrownArray.length > 0) {
    ...
    addedXtime =
      fullyGrownArray[randPos].x - Math.floor(fullyGrownArray[randPos].x / 4);
...
function draw() {
  ...
  if (pause == false && pausePressed == false) {
    ...
    //x=375 y=75
    console.log("X: " + walkXpos)
    console.log("Y: " + walkYpos)
    if (walkYpos <= 125 && is_walkYpos_height125_complete == false) {
      ...
      atkBool == true &&
      walkXpos <= fullyGrownArray[randPosGlobal].xPos &&
      walkYpos <= fullyGrownArray[randPosGlobal].yPos
    ) {
      walkXpos += 2;
      walkYpos += 2;
      ...
      atkBool == true &&
      fullyGrownArray[randPosGlobal].yPos <= walkYpos - 4 &&
      is_walkYpos_heightRand_complete == false
    ) {
    ...
    // }
      ...
      //for "attack"ing enemy mid walk - moves & hides them
      myDivWalk.hide();
      myDiv.hide();
    }
    ...
    if (
      atkBool == true &&
      walkXpos >= fullyGrownArray[randPosGlobal].xPos - 10 &&
      walkYpos >= fullyGrownArray[randPosGlobal].yPos - 10 &&
      walkYpos <= fullyGrownArray[randPosGlobal].yPos + 10
    ) {
      myDivWalk.hide();
    ...
    if (
      timeLeftGlobal <= addedYtime + addedXtime - Math.floor(addedXtime / 3) &&
      timerActive == true &&
      successAttack == false
    ) {
      myDiv.hide();
    ...
    if (waterCan == false && spear == false && holdSeedPumpkin == false) {
      ...
      avatar_spear_defaultL.hide();
      avatar_spear_defaultR.hide();
      avatar_seedPumpkin_defaultL.hide();
      avatar_seedPumpkin_defaultR.hide();
      ...
      avatarMove(
        ...
        extraXdef_R,
        extraYdef,
        avatar_spearAttack_defaultL,
        avatar_spearAttack_defaultR,
        avatar_spearAttack_left,
        avatar_spearAttack_right,
        avatar_spearAttack_up,
        avatar_spearAttack_down
      );
      ...
      avatarMove(
        ...
        avatar_carry_up,
        avatar_carry_down,
        avatar_carry_defaultL,
        avatar_carry_defaultR,
        moveSpeed_can,
        extraXcarry_L,
        extraXcarry_R,
        extraYcarry,
        avatar_pour_defaultL,
        avatar_pour_defaultR,
        avatar_pour_left,
        avatar_pour_right,
        avatar_pour_up,
        avatar_pour_down
    ...
    if (spear == true && waterCan == false && holdSeedPumpkin == false) {
      ...
      avatarMove(
        ...
        avatar_spear_up,
        avatar_spear_down,
        avatar_spear_defaultL,
        avatar_spear_defaultR,
        moveSpeed_can,
        extraXspear_L,
        extraXspear_R,
        extraYspear,
    ...
    if (holdSeedPumpkin == true && waterCan == false && spear == false) {
      ...
      avatar_default.hide();
      avatarMove(
        avatar_seedPumpkin_right,
        avatar_seedPumpkin_left,
        avatar_seedPumpkin_up,
        avatar_seedPumpkin_down,
        avatar_seedPumpkin_defaultL,
        avatar_seedPumpkin_defaultR,
        moveSpeed_can,
        extraXseedP_L,
        extraXseedP_R,
        extraYseedP,
