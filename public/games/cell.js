function preload() {
  ...
  avatar_seedPumpkin_defaultL = createImg(
    "images/bear_pumpkinseed_default.png"
  );
  avatar_seedPumpkin_defaultR = createImg(
    "images/bear_pumpkinseed_default.png"
  );
  ...
  avatar_seedPumpkin_defaultL.size(116, 56);
  avatar_seedPumpkin_defaultR.size(116, 56);
  avatar_seedPumpkin_left.size(116, 56);
  avatar_seedPumpkin_right.size(116, 56);
  avatar_seedPumpkin_up.size(116, 56);
  avatar_seedPumpkin_down.size(116, 56);
}
...
cell.prototype.show = function () {
  ...
  if (this.firstStage) {
    ...
    image(pumpkin_stg1, this.x + 100, this.y + 135, 27, 27);
  }

  if (this.firstWetStage) {
    //stg 1 watered

    image(pumpkin_stg1_w, this.x + 100, this.y + 135, 27, 27);

    //  image(stg3, this.x+103, this.y+125, 30, 30);
  }
  if (this.secondStage) {
    image(pumpkin_stg2, this.x + 100, this.y + 135, 27, 27);
  }
  if (this.secondWetStage) {
    //backgroundImg(this.x,this.y,this.w,this.h);
    image(pumpkin_stg2_w, this.x + 100, this.y + 135, 27, 27);
  }
  if (this.thirdStage) {
    //backgroundImg(this.x,this.y,this.w,this.h);

    image(pumpkin_stg3, this.x + 100, this.y + 135, 27, 27);
  }
  if (this.thirdWetStage) {
    //  backgroundImg(this.x,this.y,this.w,this.h);

    image(pumpkin_stg3_w, this.x + 100, this.y + 135, 27, 27); //make img1 include brown dirt surrounding it
  ...
  if (this.fourthStage) {
    ...
    image(pumpkin_stg4, this.x + 100, this.y + 135, 27, 27);
  }
  if (this.fourthWetStage) {
    image(pumpkin_stg4_w, this.x + 100, this.y + 135, 27, 27);
  }
  if (this.fifthStage) {
    image(pumpkin_stg5, this.x + 100, this.y + 135, 27, 27);
  }
